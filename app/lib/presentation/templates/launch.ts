...
/**
 * The immutable launch template: the original Comake deck, moved verbatim from
 * the former hardcoded `createLaunchDeck()` singleton. Read-only code data —
 * every project is cloned from it with fresh ids, never referenced.
 */

const initialSlideId = 'slide-gap';
...
const gap = slide(initialSlideId, 'The co-work gap', '#20201b', [
...
export const launchTemplate: PresentationTemplate = {
  id: 'comake-launch',
